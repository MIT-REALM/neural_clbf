...
class LinearSatellite(ControlAffineSystem):
    ...
    representing the force applied in each axis applied.

    The system is parameterized by
        mu: Earth's gravity constant
        a: the length of the semi-major axis of the target's orbit
    """
    ...
    def validate_params(self, params: Scenario) -> bool:
        ...
        valid = valid and "mu" in params
        valid = valid and "a" in params

        # Make sure all parameters are physically valid
        valid = valid and params["mu"] > 0
