"""Simulate a rollout and plot in state space, for a multiagent system"""
import random
import time
...
class RolloutMultiagentStateSpaceExperiment(Experiment):
    """An experiment for plotting rollout performance of controllers.

    Plots trajectories projected onto a 3D plane.
    """
    ...
    def __init__(
        ...
        """
        super(RolloutMultiagentStateSpaceExperiment, self).__init__(name)
        ...
        self.plot_z_index = plot_z_index
        self.plot_z_label = plot_z_label
    ...
    def plot(
        ...
        for plot_idx, sim_index in enumerate(results_df["Simulation"].unique()):
            ...
            rollout_ax.plot3D(
                ...
                results_df[sim_mask][self.plot_z_label].to_numpy(),
                linestyle="-",
                # marker="+",
                markersize=5,
            ...
            rollout_ax.set_zlabel(self.plot_z_label)
