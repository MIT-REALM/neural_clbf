...
@torch.no_grad()
def save_kscar_s_curve_rollout(
    ...
    """
    Simulate a rollout of the KSCar and saves it to a CSV
    ...
    args:
        ...
        dynamics_model: the KSCar model used to simulate
    ...
    filename = "sim_traces/"
    filename += f"kscar_{controller_name}_dt={controller_period_str}"
    if randomize_path:
    ...
    header = "sxe,sye,delta,ve,psi_e,omega_ref,psi_ref,v_ref,a_ref"
    header += ",x_ref,y_ref"
